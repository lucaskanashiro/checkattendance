...
public class TeacherDetailSeminarTest {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void teacherDetailSeminarTest() throws InterruptedException {
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.btn_qr_code_teacher),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.custom),
                                        0),
        ...
        ViewInteraction button2 = onView(
                allOf(withId(R.id.btn_bluetooth_teacher),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.custom),
                                        0),
        ...
        ViewInteraction button3 = onView(
                allOf(withId(R.id.btn_list_attendees),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.custom),
                                        0),
        ...
        ViewInteraction button4 = onView(
                allOf(withId(R.id.btn_edit_seminar),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.custom),
                                        0),
